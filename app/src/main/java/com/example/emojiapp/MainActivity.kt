...
class MainActivity : AppCompatActivity() {
    ...
    inner class EmojiFilter:InputFilter {
        override fun filter(source: CharSequence?, start: Int, end: Int, dest: Spanned?,
            ...
            Log.i(TAG, "Added text $source, it has lenght ${source.length} characters")
            ...
            // If the text is invalid, return source.
            return source
        }
    ...
    private fun showAlertDialog() {
        ...
        // Restruct input length
        val lengthFilter = InputFilter.LengthFilter(12)
        // Restrict the input of characters to only emojis.
